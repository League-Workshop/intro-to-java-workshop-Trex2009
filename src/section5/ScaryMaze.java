...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	if (mouseColor == greenBackground) {
		JOptionPane.showMessageDialog(null, "YOU WON, thanks for not rage quitting!!!");
	}
